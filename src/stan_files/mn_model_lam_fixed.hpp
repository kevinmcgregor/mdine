...
namespace model_mn_model_lam_fixed_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_mn_model_lam_fixed");
    reader.add_event(126, 124, "end", "model_mn_model_lam_fixed");
    return reader;
}
    ...
    try {
        ...
        for (int i = 1; i <= mat_dim; ++i) {
            ...
            for (int j = 1; j <= (i - 1); ++j) {
                ...
                stan::math::assign(f, stan::model::deep_copy((f + stan::math::fabs(get_base1(y,i,j,"y",1)))));
            }
        }
...
#include <meta_header.hpp>
 class model_mn_model_lam_fixed : public prob_grad {
private:
    int n;
    int k;
    int p;
    ...
    double lambda_half;
public:
    model_mn_model_lam_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_mn_model_lam_fixed_namespace::model_mn_model_lam_fixed";
        ...
        try {
            ...
            inv_lambda = double(0);
            stan::math::fill(inv_lambda,DUMMY_VAR__);
            current_statement_begin__ = 35;
            lambda_half = double(0);
            ...
            stan::math::assign(inv_lambda, (1 / lambda));
            ...
            current_statement_begin__ = 33;
            current_statement_begin__ = 34;
            check_greater_or_equal(function__,"inv_lambda",inv_lambda,0);
            current_statement_begin__ = 35;
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > lin_pred_rand;
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  invsigma0(static_cast<Eigen::VectorXd::Index>((k - 1)),static_cast<Eigen::VectorXd::Index>((k - 1)));
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  invsigma1(static_cast<Eigen::VectorXd::Index>((k - 1)),static_cast<Eigen::VectorXd::Index>((k - 1)));
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > probs(n, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>(k))));
            ...
            vector<Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> > lin_pred(n, (Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,1> (static_cast<Eigen::VectorXd::Index>((k - 1)))));
            ...
            for (int j1 = 1; j1 <= (k - 1); ++j1) {
                ...
                for (int j2 = 1; j2 <= j1; ++j2) {
                    ...
                    if (as_bool(logical_eq(j1,j2))) {
                        ...
                        lp_accum__.add(double_exponential_log<propto__>(get_base1(invsigma0,j1,j2,"invsigma0",1), 0, inv_lambda));
                        current_statement_begin__ = 103;
                        lp_accum__.add(double_exponential_log<propto__>(get_base1(invsigma1,j1,j2,"invsigma1",1), 0, inv_lambda));
                    }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_mn_model_lam_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  beta(static_cast<Eigen::VectorXd::Index>(p),static_cast<Eigen::VectorXd::Index>((k - 1)));
            ...
            validate_non_negative_index("invsigma_diff", "(k - 1)", (k - 1));
            Eigen::Matrix<local_scalar_t__,Eigen::Dynamic,Eigen::Dynamic>  invsigma_diff(static_cast<Eigen::VectorXd::Index>((k - 1)),static_cast<Eigen::VectorXd::Index>((k - 1)));
    ...
    static std::string model_name() {
        return "model_mn_model_lam_fixed";
    }
...
typedef model_mn_model_lam_fixed_namespace::model_mn_model_lam_fixed stan_model;
